...
class _HomeTabContentState extends State<_HomeTabContent> {
  ...
  final List<String> _filters = ['All', 'Music', 'Charts', 'Moods'];
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          if (_loading)
            ...
            // 1. 2-COLUMN QUICK ACCESS GRID (SPOTIFY SIGNATURE)
            SliverToBoxAdapter(
              child: Padding(
            ...
            // 5. DYNAMIC SECTIONS (Newly Released, Trending, Charts)
