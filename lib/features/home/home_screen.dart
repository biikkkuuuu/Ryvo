...
shadowColor: RyvoThemeController.themes[RyvoThemeController.instance.selectedTheme].primary
...
color: RyvoThemeController.themes[RyvoThemeController.instance.selectedTheme].primaryLight,
size: 29,
),
),
...
colors: [
RyvoThemeController.themes[RyvoThemeController.instance.selectedTheme].primary,
RyvoThemeController.themes[RyvoThemeController.instance.selectedTheme].primaryDark,
],
),
),
child: Icon(
...
RyvoThemeData get _theme =>
RyvoThemeController.themes[
RyvoThemeController.instance.selectedTheme
];

List<Color> get _backgroundGradient => [
_theme.primaryDark.withValues(alpha: 0.95),
Color.lerp(_theme.primaryDark, Colors.black, 0.30)!,
Color.lerp(_theme.primaryDark, Colors.black, 0.62)!,
const Color(0xff0A0614),
];

List<Color> get _headerGradient => [
_theme.primaryDark,
Color.lerp(_theme.primaryDark, Colors.black, 0.18)!,
Color.lerp(_theme.primaryDark, Colors.black, 0.38)!,
];

Color get _baseBackground =>
Color.lerp(_theme.primaryDark, Colors.black, 0.78)!;
...
void initState() {
super.initState();
RyvoThemeController.instance.addListener(_onThemeChanged);
loadHome();
}

@override
void dispose() {
RyvoThemeController.instance.removeListener(_onThemeChanged);
super.dispose();
}
...
Widget build(BuildContext context) {
return Scaffold(
backgroundColor: _baseBackground,
...
colors: [
Colors.transparent,
_baseBackground.withValues(alpha: 0.48),
_baseBackground.withValues(alpha: 0.88),
const Color(0xff0A0614),
],
...
shadowColor:
_theme.primary.withValues(alpha: 0.06),
child: SizedBox(
height: 82,
child: Padding(
padding:
...
height: 44,
decoration: BoxDecoration(
color: (iconColor ?? _theme.primaryLight).withValues(
alpha: 0.12,
),
borderRadius:
...
child: Icon(
icon,
color: iconColor ?? _theme.primaryLight,
size: 22,
),
),
