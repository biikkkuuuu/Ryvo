...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      final artists = await _repository.artistSuggestions(q);
      final normalizedQuery = q.toLowerCase();

      final exactArtist = artists.where((artist) =>
        artist.name.trim().toLowerCase() == normalizedQuery,
      ).firstOrNull;
